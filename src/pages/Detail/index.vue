        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <!-- //属性选择 -->
              <dl v-for="k in spuSaleAttrList" :key="k.id">
                <dt class="title">选择{{k.saleAttrName}}</dt>
                <dd changepirce="0" @click="changeActive(attr,k.spuSaleAttrValueList)" :class="{active:attr.isChecked==1}" v-for="attr in k.spuSaleAttrValueList" :key="attr.id">{{attr.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" type=""  class="itxt" v-model.number="skuNum" @input="changeskuNum">
...
<script>
  ...
  export default {
    ...
    computed:{
      // ...mapState('datail',{goodsInfo:"goodsInfo"})
    ...
    methods: {
     ...
     async addShopcar()
      {
        const loction={skuId:this.$route.params.skuid,skuNum:this.skuNum}
      try {
