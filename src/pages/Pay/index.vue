<template>
  <div class="pay-main">
    <el-button type="success" icon="el-icon" circle>提交</el-button>
    ...
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <el-button type="danger" size="default" @click="open()">
            立即支付
          </el-button>
        </div>
        <div class="otherpay">
...
export default {
  ...
  methods: {
    ...
    async open() {
      //生成一个二维码
      var url = await QRCode.toDataURL(this.payInfo.codeUrl);
      this.imgUrl = url;
