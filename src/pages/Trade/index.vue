  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeDeault(address, AddressInfo)">
      ...
      <div class="way">
        ...
        <div class="info clearFix">
          ...
          <p>配送时间：预计{{ comeTime }}09:00-15:00送达</p>
        </div>
      </div>
      <div class="detail">
        <h5>商品清单</h5>
    ...
    <div class="sub clearFix">
      ...
      <a @click="toPay" class="subBtn">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch("trade/getOrederInfo");
  },
  computed: {
    ...
    comeTime() {
      return `${moment()
        .add(2, "days")
        .format("MM DD")}  ${new Date().getDay()}   `;
    },
  },
  methods: {
    changeDeault(address, AddressInfo) {
      //所有isDefault为零
